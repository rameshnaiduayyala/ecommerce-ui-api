...
const WalmartProductCard = ({ product }) => {
  ...
  const priceDec = Math.round((displayPrice - priceInt) * 100).toString().padStart(2, '0');
              ...
              {discountPrice ? (
                <>
                  <span className="wm-price-now">
                    ₹{priceInt}<sup className="wm-price-decimal-sup">{priceDec}</sup>
                  </span>
            ...
            <div className="wm-quickview-grid">
              ...
              <div className="wm-qv-details">
                ...
                <div className="wm-qv-price-row">
                  <span className="wm-qv-price-now">₹{displayPrice.toFixed(0)}</span>
                  {discountPrice && (
                    <>
